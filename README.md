# Windows Native Unix Shell (wnus) - Version 0.1.2.3
...
[![Version](https://img.shields.io/badge/version-0.1.2.3-orange.svg)](.))

## 🌟 Overview

**Windows Native Unix Shell (wnus)** is a standalone bash-like console application for Windows that provides:
- **281+ commands** all fully implemented (0 stubs)
...
### Core Capabilities
- 🔧 **281+ Unix/Linux commands** implemented natively in C++
...
- ~5.98 MB disk space for executable
- ~24-32 MB RAM typical usage
...
- `sed`, `awk` - Pattern matching and text processing (sed refactored v0.1.2.2)
...
- **Technical improvements**:
  ...
  - All 281+ commands fully implemented (0 stubs)
